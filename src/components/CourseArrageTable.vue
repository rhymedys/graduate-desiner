<template>
  <div>
    ...
    <el-table class="tempform-table" v-bind:data="tableDataResource" border style="width: 100%;" ref="comfirmTable" @selection-change="selectionChange" >
      ...
      <el-table-column prop="course.content" label="授课内容" width="250" v-if="showCourseContent">
      </el-table-column>
      <el-table-column prop="course.type" label="授课方式" width="180">
      </el-table-column>
      <el-table-column prop="course.major" label="专业" width="180">
      </el-table-column>
      <el-table-column prop="course.address" label="教室" width="120">
      </el-table-column>
      <el-table-column prop="course.teacher" label="教师" width="180">
      </el-table-column>
      ...
      <el-table-column prop="opertate" label="操作" width="180" fixed="right">
        <template scope="scope">
